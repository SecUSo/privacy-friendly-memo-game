...
public enum MemoryDifficulty {
    ...
    private static List<MemoryDifficulty> validDifficulties = new LinkedList<>();
    ...
    MemoryDifficulty(@StringRes int resID, int deckSize) {
        this.resID = resID;
    ...
    public static List<MemoryDifficulty> getValidDifficulties(){
