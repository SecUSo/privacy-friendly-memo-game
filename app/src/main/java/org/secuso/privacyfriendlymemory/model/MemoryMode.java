...
public enum MemoryMode {
    ...
    private static List<MemoryMode> validTypes = new LinkedList<>();
    ...
    MemoryMode(@StringRes int resIDString, @DrawableRes int resIDImage, int playerCount){
    ...
    public static List<MemoryMode> getValidTypes(){
        return validTypes;
    }
}
